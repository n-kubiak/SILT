...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--no_norm', type=int, default=1, help='normalize images?')
        ...
        self.parser.add_argument('--use_os_loss', type=int, default=1, help='use Output Similarity loss, ie make outA&B similar')
        self.parser.add_argument('--use_gradient_loss', type=int, default=1, help='spatial gradient loss, between outputs')
        self.parser.add_argument('--use_reflectance_loss', type=int, default=1, help='compare shading between branches')
        ...
        self.parser.add_argument('--checkpoints_dir', type=str, default='/vol/research/relighting/code/SILT/checkpoints/')
        self.parser.add_argument('--tb_log', action='store_true', help='if specified, use tensorboard logging')
        self.parser.add_argument('--tb_dir', type=str, default='$YOUR-DIR')
        ...
        # for generator -> copied directly from pix2pix
        ...
        # for discriminator -> copied directly from pix2pix
