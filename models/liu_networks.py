##################################################################################
# Code source: https://github.com/DreamtaleCore/USI3D
# Paper: "Unsupervised Learning for Intrinsic Image Decomposition From a Single Image", Liu et al, CVPR 2020
##################################################################################
...
class IntrinsicSplitor(nn.Module):
    def __init__(self, feature_len=32, hidden_dim=256, n_layers=5, activ='relu'):  # values copied from yaml file
